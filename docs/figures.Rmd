...
tbl = read.csv("../data/full_sum_20220810.csv")
...
knitr::include_graphics('..//figures/bloom_centers_20220810.png')
```
...
knitr::include_graphics(c('..//figures/bloom_durations_20220810.png'))
```
