...
tbl = read.csv("../data/outfiles/full_sum_2.csv")
...
knitr::include_graphics(c('../figs/thumbnail_20220713_latesummer.png'))
```

\newpage  

## Figure 2: HPLC against Satellite CHL Comparison and CHL Climatologies
...
knitr::include_graphics( '..//figs/HPLC_CHL_clim.png')
```
  
\newpage  

\captionsetup{justification=justified,margin=1cm}
## Figure 3:  k-means cluster analysis of (sub)mesoscale regions
...
knitr::include_graphics('..//figs//triplot_20220802.png')
``` 

\newpage 

## Figure 4: Two late summer CHL blooms relationship to fronts and eddies
...
knitr::include_graphics(c('..//figs/eddies_fronts_blooms.png'))
```

\newpage  

## Figure 5: Spatio-temporal evolution of the 2018 bloom
...
knitr::include_graphics(c('..//figs/thumbnail_2018_20220719.png'))
```

\newpage  

## Figure 6: Satellite-based time series of the 2018 bloom
...
knitr::include_graphics(c('..//figs/biomass_conc_area.png'))
```

\newpage  

## Figure 7: Spatial association of (sub)mesoscale features across the lifespan of the 2018 bloom
\captionsetup{justification=justified,margin=3cm}
...
knitr::include_graphics(c('..//figs/submeso_timeseries.png'))
```

\newpage  

## Figure 8: Bloom centers and maximum area
\captionsetup{justification=justified,margin=0.5cm}
...
knitr::include_graphics('..//figs/bloom_centers_area_20220725.png')
```


\newpage  

## Figure 9: Bloom duration and day of year
\captionsetup{justification=justified,margin=0.5cm}
...
knitr::include_graphics(c('..//figs/bloom_durations_20220725_2.png'))
```
