...
tbl = read.csv("../data/full_sum_2.csv")
...
knitr::include_graphics('..//figures/bloom_centers_area_20220725.png')
```
...
knitr::include_graphics(c('..//figures/bloom_durations_20220725_2.png'))
```
