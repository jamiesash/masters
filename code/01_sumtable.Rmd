...
sumtbl = sumstats(blooms = chl_b, signal1 = chl, signal2 = chl_a, sdate = blooms$sdate, edate = blooms$edate)
gc()
```
saving tables as csv
```{r, eval = FALSE, message = FALSE, warning = FALSE,}
write.csv(sumtbl, file = "../data/full_sum_20220928.csv")
gc()
```
...
```{r, message = FALSE, fig.show = "hold", fig.width = 8,  warning = FALSE}
