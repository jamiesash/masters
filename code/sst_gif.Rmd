...
zlim = c(-3, 2)
sst_clamp = raster::clamp(ssta[[20]], zlim[1], zlim[2])

plot(sst_clamp, col = cmocean("ice")(25), zlim = zlim)
...
e = extent(ssta)
wdmap = getMap(resolution = "high")
ssta_clamp = raster::clamp(ssta, zlim[1], zlim[2])

ani.record(reset = TRUE)
for(i in 1:s[3]){
  plot(ssta_clamp[[i]], zlim = zlim, col = cmocean("ice")(25))
  box(which = "plot", lty = "solid", lwd = 3, col = "grey25")
  plot(wdmap, 
       xlim = e[1:2], 
       ylim = e[3:4], 
